    ...
    <footer className="px-4 divide-y bg-gray-800 text-gray-100 ">
      <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        ...
        <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
          ...
          <div className="space-y-3">
            <h5 className="tracking-wide uppercase text-gray-50">Company</h5>
            <ul className="space-y-1">
              <li>
                <a rel="noopener noreferrer" href="#">
                  Privacy
          ...
          <div className="space-y-3">
            <h5 className="uppercase text-gray-50">Developers</h5>
            <ul className="space-y-1">
              <li>
                <a rel="noopener noreferrer" href="#">
                  Public API
          ...
          <div className="space-y-3">
            <h5 className="uppercase text-gray-50">Social media</h5>
            <div className="flex justify-start space-x-3 space-y-1">
              <a
                rel="noopener noreferrer"
                href="#"
                title="Facebook"
